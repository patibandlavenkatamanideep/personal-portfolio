...
const allProjects: Project[] = [
  // Healthcare & Medical AI
  {
    ...
    details: {
      ...
      features: ["Automated image preprocessing pipeline", "GPU-optimized inference for real-time analysis", "RESTful API for seamless integration", "Support for multiple X-ray image formats", "Confidence scoring for predictions", "CI/CD pipeline for continuous deployment"],
      impact: ["Processed 10,000+ medical images", "Achieved 88% diagnostic accuracy", "Reduced analysis time from minutes to seconds", "Enabled faster clinical decision-making"],
      timeline: "3 months"
    }
  },
  {
    ...
    details: {
      ...
      features: ["CNN-based image classification model", "TensorFlow/Keras deep learning pipeline", "Flask web application for inference", "DVC for data and model versioning", "Docker containerization", "AWS EC2 & ECR deployment", "GitHub Actions CI/CD pipeline"],
      impact: ["Automated disease detection", "Production-ready AWS deployment", "Reproducible ML workflow with DVC", "Scalable containerized solution"],
      timeline: "3 months"
    }
  },
  {
  ...
  },
  {
    ...
    details: {
      ...
      features: ["Natural language understanding", "Medical knowledge base integration", "Context-aware conversations", "Safety guardrails for medical advice", "Multi-turn dialogue management", "Source citation for information"],
      impact: ["24/7 medical information access", "Reduced burden on healthcare staff", "Improved patient education", "Scalable healthcare assistance"],
      timeline: "2 months"
    }
  },
  // MLOps & Production Systems
  {
    ...
    details: {
      ...
      features: ["Modular ML pipeline (Ingestion, Validation, Training, Evaluation)", "MongoDB for scalable data storage", "EvidentlyAI for data drift & model monitoring", "Flask web application for predictions", "Docker containerization", "GitHub Actions CI/CD workflows", "EasyVisa dataset integration"],
      impact: ["Automated visa screening predictions", "Real-time model monitoring for drift detection", "Production-ready containerized deployment", "Reproducible ML workflows"],
      timeline: "3 months"
    }
  },
  {
    ...
    details: {
      ...
      features: ["Data ingestion and validation", "Feature engineering pipeline", "Model training with hyperparameter tuning", "Model registry and versioning", "Automated testing and validation", "Production deployment automation"],
      impact: ["Reduced deployment time by 70%", "Enabled reproducible experiments", "Automated model monitoring", "MIT licensed for community use"],
      timeline: "3 months"
    }
  },
  {
    ...
    details: {
      ...
      features: ["Comprehensive EDA and visualization", "Feature engineering and selection", "Multiple algorithm comparison", "Cross-validation and hyperparameter tuning", "Model performance benchmarking", "Interpretable predictions"],
      impact: ["Objective quality assessment", "Consistent rating system", "Cost-effective quality control", "Data-driven decision making"],
      timeline: "2 months"
    }
  },
  {
    ...
    details: {
      ...
      features: ["Student data preprocessing", "Performance prediction models", "Automated training pipelines", "Model versioning and tracking", "Early warning indicators", "Intervention recommendations"],
      impact: ["Early identification of at-risk students", "Data-driven intervention strategies", "Improved student outcomes", "Scalable across institutions"],
      timeline: "2 months"
    }
  },
  // Computer Vision
  {
    ...
    details: {
      ...
      features: ["YOLOv8-based pose estimation", "Real-time video stream processing", "AWS Lambda for serverless deployment", "Instant alert notifications", "Model quantization for edge devices", "40% reduced inference costs"],
      impact: ["95% fall detection accuracy", "Sub-3 second alert latency", "40% reduction in inference costs", "Enhanced elderly safety monitoring"],
      timeline: "4 months"
    }
  },
  // Forecasting & Predictive Analytics
  {
    ...
    details: {
      ...
      features: ["Streamlit interactive dashboard", "XGBoost and LightGBM models", "Ensemble prediction methods", "Real-time forecast updates", "Interactive visualizations", "CSV export functionality"],
      impact: ["Instant sales predictions", "Improved inventory planning", "User-friendly interface", "Data-driven business decisions"],
      timeline: "2 months"
    }
  },
  {
    ...
    details: {
      ...
      features: ["Comprehensive data cleaning", "Feature engineering pipeline", "Random Forest classification", "Cross-validation analysis", "Model performance metrics", "Kaggle dataset integration"],
      impact: ["High prediction accuracy", "Agricultural planning support", "Disaster preparedness", "Water resource optimization"],
      timeline: "1 month"
    }
  },
  {
    ...
    details: {
      ...
      features: ["Applicant data analysis", "Feature engineering for finance", "Multiple classification algorithms", "Model comparison and selection", "Risk score generation", "Interpretable predictions"],
      impact: ["Faster loan processing", "Consistent approval criteria", "Reduced manual effort", "Risk-aware lending"],
      timeline: "1 month"
    }
  },
  // Business Intelligence
  {
    ...
    details: {
      ...
      features: ["Real-world business scenarios", "SQL query analysis", "Python data processing", "Statistical hypothesis testing", "Interactive visualizations", "Actionable recommendations"],
      impact: ["Demonstrated analytical skills", "Multi-tool proficiency", "Industry-relevant solutions", "Community recognition (starred)"],
      timeline: "Ongoing"
    }
  },
  {
    ...
    details: {
      ...
      features: ["Interactive Power BI dashboard", "Match-by-match analysis", "Player performance metrics", "Team comparison charts", "Historical trend analysis", "Filtering and drill-down"],
      impact: ["Easy data exploration", "Visual storytelling", "Fan engagement", "Sports analytics showcase"],
      timeline: "1 month"
    }
  },
  // NLP & Automation
  {
    ...
    details: {
      ...
      features: ["n8n workflow orchestration", "GPT-4 powered analysis", "Resume optimization engine", "Skills extraction and matching", "Multi-stage LLM pipeline", "Automated application tracking"],
      impact: ["90% reduction in manual effort", "Consistent resume quality", "Faster application turnaround", "Improved job match rates"],
      timeline: "2 months"
    }
  },
  {
    ...
    details: {
      ...
      features: ["LSTM time-series forecasting", "AWS Step Functions orchestration", "CloudWatch monitoring", "Automated model retraining", "Failure prediction alerts", "Distributed processing"],
      impact: ["30% improvement in prediction accuracy", "40% reduction in maintenance costs", "Minimized unplanned downtime", "Optimized maintenance schedules"],
      timeline: "4 months"
    }
  },
];
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 animate-fade-in" style={{ animationDelay: '0.1s' }}>
          {[
            ...
            { label: "Categories", value: "6", icon: Database },
        ...
        {/* Full Recruiter CTA at bottom */}
        <RecruiterCTA variant="full" />
      </div>
